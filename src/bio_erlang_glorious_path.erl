%%% This module genetates the path walk through the sequences, resulting in
%%% the best alignment found in score map.
-module(bio_erlang_glorious_path).
-export([find/1]).
...
%% Returns the path generated by backingtracking score map.
%% 1st param -> 3-ple with two sequences, alignment's setup and score map. 
find(NWResult) ->
    {Sequences, _, ScoreMap} = NWResult,
    Start = bio_erlang_needleman_wunsch:last_point(Sequences),
